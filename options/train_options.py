...
class TrainOptions(BaseOptions):
	def initialize(self):
		...
		self.parser.add_argument('--measure_time', type=bool, default=True, help='measure time of different steps during training')
		...
		self.parser.add_argument('--num_batch', default=50000, type=int, help='number of batches to train')
